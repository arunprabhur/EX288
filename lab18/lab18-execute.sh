...
execute "view the pipeline using tekton" '''tkn p describe myfirst-pipeline'''
execute "view the task using tekton" '''tkn t describe myfirsttask'''
execute "Trigger the pipeline from tekton" '''tkn p start myfirst-pipeline -w name=pipeworkspace,volumeClaimTemplateFile=shared-volume-pipeline.yaml'''
execute "view logs of pipeline" '''tkn p logs myfirst-pipeline -f'''
