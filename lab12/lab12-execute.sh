...
execute "Creating New app for the bash app from git" '''oc new-app --strategy docker --name mybashapp --context-dir /lab122 https://github.com/arunprabhur/EX288.git '''
